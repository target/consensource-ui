...
const _localStoreSave = (key, value) => localStorage.setItem(`${AuthService.namespace}/${key}`, value);

const _localStoreGet = key => localStorage.getItem(`${AuthService.namespace}/${key}`);

const _localStoreRemove = key => localStorage.removeItem(`${AuthService.namespace}/${key}`);

const _sessionStoreSave = (key, value) => sessionStorage.setItem(`${AuthService.namespace}/${key}`, value);

const _sessionStoreGet = key => sessionStorage.getItem(`${AuthService.namespace}/${key}`);

const _sessionStoreRemove = key => sessionStorage.removeItem(`${AuthService.namespace}/${key}`);
