...
const _authButtons = () => {
  if (AuthService.isSignedIn()) {
    ...
    return [
      m(
        "a.btn.btn-outline-success[href=/signIn]",
        { oncreate: m.route.link },
        "Sign In"
      ),
    ...
    m("div.landing-page.landing-page-auditor", [
      m("div.landing-page-info", [
        ...
        m("ul.landing-page-info-section", [
          ...
          m(
            "li",
            "+ Search a list of factories that have been audited and certified"
          ),
          m(
            "li",
            "+ Rest assured that both past and current date are accurate and up-to-date"
          )
        ]),
        m(
          ...
          {
            href: `${
              AuthService.isSignedIn() ? "/organizationCreate" : "/signIn"
            }`,
            oncreate: m.route.link
          },
